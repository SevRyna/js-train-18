...
function checkData(data) {
  ...
  const checkData = Error("Об'єкт пустий");
...
function parseJson(jsonStr) {
  try {
    ...
    // Якщо рядок має невірний формат, виникне помилка, яку ми обробляємо у блоку
...
function evaluateExpression(expression) {
  try {
    ...
    // Якщо була виявлена помилка повертаємо помилку при виконанні функції
